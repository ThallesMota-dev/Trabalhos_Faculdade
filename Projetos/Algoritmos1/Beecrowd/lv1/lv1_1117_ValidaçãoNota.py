...
n1 = float(input()) # leitura da primeira nota
while (n1 < 0 or n1 > 10): # validação da primeira nota
    print ("nota invalida") # mensagem de nota inválida
    n1 = float(input()) # leitura da primeira nota novamente 
n2 = float(input()) # leitura da segunda nota
while (n2 < 0 or n2 > 10): # validação da segunda nota 
    print ("nota invalida") # mensagem de nota inválida
    n2 = float(input()) # leitura da segunda nota novamente 
media = (n1 + n2) / 2 # cálculo da média
print (f"media = {media:.2f}") # impressão da média com duas casas decimais